;------------------------------------------------------------------------------
; Filename: touch_plate_cycles_inside_corner.cnc
; Description: Inside Corner Touch Plate Cycles
; Notes:
...
IF <TOUCH_PLATE_CYCLE_SELECT> == 8  THEN GOTO 100
IF <TOUCH_PLATE_CYCLE_SELECT> == 10 THEN GOTO 200
IF <TOUCH_PLATE_CYCLE_SELECT> == 12 THEN GOTO 300
IF <TOUCH_PLATE_CYCLE_SELECT> == 14 THEN GOTO 400

GOTO 1000 ;End Macro, Selection Invalid

;------------------------------------------------------------------------------
;   Inside Top Left Cycle
;------------------------------------------------------------------------------
N100
