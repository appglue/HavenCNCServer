;------------------------------------------------------------------------------
; Filename: touch_plate_cycles_outside_side.cnc
; Description: Outside Side Touch Plate Cycles
; Notes:
...
;------------------------------------------------------------------------------
; Usage: G65 "#400\system\touch_plate_cycles_outside_side.cnc"
;
; Input:
...
IF <TOUCH_PLATE_CYCLE_SELECT> == 1 THEN GOTO 100
IF <TOUCH_PLATE_CYCLE_SELECT> == 3 THEN GOTO 200
IF <TOUCH_PLATE_CYCLE_SELECT> == 5 THEN GOTO 300
IF <TOUCH_PLATE_CYCLE_SELECT> == 7 THEN GOTO 400
