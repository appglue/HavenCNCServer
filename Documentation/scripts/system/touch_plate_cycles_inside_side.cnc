;------------------------------------------------------------------------------
; Filename: touch_plate_cycles_inside_side.cnc
; Description: Inside Side Touch Plate Cycles
; Notes:
...
;------------------------------------------------------------------------------
; Usage: G65 "#400\system\touch_plate_cycles_inside_side.cnc"
;
; Input:
...
IF <TOUCH_PLATE_CYCLE_SELECT> == 9  THEN GOTO 100
IF <TOUCH_PLATE_CYCLE_SELECT> == 11 THEN GOTO 200
IF <TOUCH_PLATE_CYCLE_SELECT> == 13 THEN GOTO 300
IF <TOUCH_PLATE_CYCLE_SELECT> == 15 THEN GOTO 400
...
M125 /Y[<SAVED_INITIAL_AXIS_2_POSITION> - <SV_AXIS_2_ACTIVE_WCS_VALUE> + [<PARAM_TOUCH_PLATE_DIAMETER> * 0.75 * -1]] P[<TOUCH_PLATE_INPUT>] F[<PARAM_PROBE_TRAVERSE_RATE>]
...
M125 /Y[<TOUCH_PLATE_PROBED_POINT_2_POSITION> + [<PARAM_TOUCH_PLATE_DIAMETER> + [<TOOL_DIAMETER_VALUE> / 2]] * 1] P[<TOUCH_PLATE_INPUT>] F[<PARAM_PROBE_TRAVERSE_RATE>]
...
M125 /Y[<TOUCH_PLATE_PROBED_POINT_2_POSITION> + [<PARAM_TOUCH_PLATE_WALL_THICKNESS> + [<TOOL_DIAMETER_VALUE> / 2]] * 1] P[<TOUCH_PLATE_INPUT>] F[<PARAM_PROBE_TRAVERSE_RATE>]
...
M125 /X[<TOUCH_PLATE_PROBED_POINT_1_POSITION> + [<PARAM_TOUCH_PLATE_WALL_THICKNESS> + [<TOOL_DIAMETER_VALUE> / 2]] * 1] P[<TOUCH_PLATE_INPUT>] F[<PARAM_PROBE_TRAVERSE_RATE>]
