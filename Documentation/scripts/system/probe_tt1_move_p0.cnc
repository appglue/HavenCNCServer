; Filename:   probe_tt1_move_p0.cnc
...
; do the tt1 move!
M[#34500] /$#[z] p0 F[#9014] ; move the specified axes in the given direction at the fast probing rate
...
M[#34500] /$#[z] p0  F[#9015]; move the specified axes in the given direction at the slow probing rate
