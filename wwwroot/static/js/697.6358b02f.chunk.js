...
const originalMessage=event.data.message;event.data.message=`${displayName}: ${statusText}`;_Logger__WEBPACK_IMPORTED_MODULE_1__.Logger.Instance.log(_Logger__WEBPACK_IMPORTED_MODULE_1__.LogCategory.DataManager,`SignalRIOUpdater: Enhanced message from "${originalMessage}" to "${event.data.message}"`);}catch(error){_Logger__WEBPACK_IMPORTED_MODULE_1__.Logger.Instance.logError(_Logger__WEBPACK_IMPORTED_MODULE_1__.LogCategory.DataManager,'Error enhancing message with I/O info:',error);}}/**
...
//# sourceMappingURL=697.6358b02f.chunk.js.map